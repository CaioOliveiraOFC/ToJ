"""A barreira arcana: a mitigação do Mago, paga em mana.
...
class TestABarreiraFunciona:
    ...
    def test_so_o_mago_tem_barreira(self):
...
class TestABarreiraCustaMana:
    ...
    def test_mago_sem_mana_fica_sem_barreira(self):
        ...
        heroi._mp = 0
        golpe = 400
        assert combat._absorve_com_barreira(heroi, golpe, None) == golpe
    ...
    def test_a_barreira_nunca_zera_o_golpe(self):
        heroi = make_hero("Mage", 20, "naked")
        assert combat._absorve_com_barreira(heroi, 10, None) >= 1
