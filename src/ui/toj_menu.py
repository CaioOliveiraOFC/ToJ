...
def typewriter_effect(
    text: str, style: str = "white", speed: float = 0.04, return_text: bool = False
) -> Text | None:
...
def splash_screen():
    ...
    console.print(
        Panel(
            Text(ascii_art, justify="center", style="bold dark_red"),
            border_style="red",
            width=console.width,
        )
    )
    ...
    for line in story_text:
        ...
        console.print(
            Panel(
                Text(line, justify="center", style="italic cyan"),
    ...
    console.print(
        Panel(
            Text.from_markup(
                "Pressione [bold green]qualquer tecla[/bold green] para começar sua aventura...",
                justify="center",
                style="bold yellow",
            ),
            border_style="yellow",
...
def game_over_screen(player_name="Aventureiro"):
    ...
    panel_content.append(
        Text(f"A MORTE TE ALCANÇOU, {player_name.upper()}!", justify="center", style="bold red")
    )
    panel_content.append("\n")
    panel_content.append(
        Text("Seu legado se perde nas sombras...", justify="center", style="dim white")
    )
    ...
    console.print(
        Panel(
            Text(
                "Toda jornada tem um fim, mas a lenda... a lenda pode recomeçar.",
                justify="center",
                style="italic white",
            ),
            border_style="dim white",
...
def display_final_stats(level: int, actions: int, battles: int, crashes: int):
    ...
    stats_table.add_row(
        "Falhas Críticas (Crashes):",
        "[red]" + str(crashes) + "[/red]" if crashes > 0 else "[green]" + str(crashes) + "[/green]",
    )
    ...
    console.print(
        Panel(
            stats_table,
            border_style="blue",
            title="[bold blue]Estatísticas da Aventura[/bold blue]",
        )
    )
    ...
    console.print(
        Panel(
            Text(
                "Obrigado por jogar Tales of the Journey! Esperamos vê-lo novamente.",
                justify="center",
    ...
    console.print(
        Panel(
            Text.from_markup(
                "Pressione [bold green]qualquer tecla[/bold green] para continuar...",
                justify="center",
                style="bold yellow",
            ),
            border_style="yellow",
...
def options_menu():
    while True:
        ...
        console.print(
            Panel(
                Text("OPÇÕES DO JOGO", justify="center", style="bold cyan"),
                border_style="cyan",
        ...
        if choice == "1":
            console.print(
                Panel(
                    Text(
                        "Função de Volume ainda não implementada.", justify="center", style="yellow"
                    ),
                    border_style="yellow",
                )
            )
            ...
            console.print(
                Panel(
                    Text(
                        "Função de Dificuldade ainda não implementada.",
                        justify="center",
                        style="yellow",
                    ),
                    border_style="yellow",
            ...
            console.print(
                Panel(
                    Text("Escolha inválida. Tente novamente.", justify="center", style="bold red"),
                    border_style="red",
                )
            )
            sleep(0.4)
...
def _prompt_for_name() -> str | None:
    ...
    while True:
        ...
        if not name:
            console.print(
                Panel(Text("Nome não pode estar em branco.", style="red"), border_style="red")
            )
            safe_get_key(allow_escape=False)
            continue
        return name
...
def show_slots_menu(title: str, allow_new: bool = True) -> int | None:
    ...
    while True:
        ...
        for i, s in enumerate(slots):
            ...
            table.add_row(f"{prefix} {s['slot']} {prefix}", name, cls, lvl, floor)
...
def select_new_slot() -> int | None:
    ...
    while True:
        ...
        if not available:
            console.print(
                Panel(Text("Todos os slots estão ocupados!", style="bold red"), border_style="red")
            )
            console.print()
...
def main_menu():
    while True:
        ...
        console.print(
            Panel(
                Text("MENU PRINCIPAL", justify="center", style="bold magenta"),
                border_style="magenta",
                subtitle="Escolha seu destino, aventureiro.",
            )
        )
        ...
        if choice == "1":
            ...
            if slot:
                console.print(
                    Panel(
                        Text(
                            f"Iniciando nova jornada no slot {slot}...",
                            justify="center",
                            style="green",
                        ),
                        border_style="green",
            ...
            if slot:
                console.print(
                    Panel(
                        Text(
                            f"Carregando aventura do slot {slot}...",
                            justify="center",
                            style="yellow",
                        ),
                        border_style="yellow",
            ...
            console.print(
                Panel(
                    Text(
                        "Até que a escuridão nos encontre novamente, aventureiro!",
                        justify="center",
                        style="red",
                    ),
                    border_style="red",
            ...
            console.print(
                Panel(
                    Text("Iniciando a simulação...", justify="center", style="magenta"),
                    border_style="magenta",
                )
            )
            sleep(0.4)
            ...
            console.print(
                Panel(
                    Text(
                        "Iniciando MODO DE TESTE com herói nível 50...",
                        justify="center",
                        style="magenta",
                    ),
                    border_style="magenta",
            ...
            console.print(
                Panel(
                    Text(
                        "Um erro em sua escolha, aventureiro. Tente novamente.",
                        justify="center",
                        style="bold red",
                    ),
                    border_style="red",
