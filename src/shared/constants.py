...
DEFENSE_REDUCTION_DIVISOR = 2  # Redução de dano pela metade da defesa
...
WARRIOR_HP_GROWTH_PERCENT = 17
WARRIOR_ST_GROWTH_PERCENT = 13

MAGE_MP_GROWTH_PERCENT = 15
MAGE_MG_GROWTH_PERCENT = 15

ROGUE_ST_GROWTH_PERCENT = 16
ROGUE_AGILITY_INCREMENT = 2
