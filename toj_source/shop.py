import math
from .items import ALL_ITEMS, RARITY_MULTIPLIERS, Potion, Weapon, Armor
...
if __name__ == "__main__":
    from toj_source.character import Player
    from toj_source.items import Inventory # Assuming Inventory is in items module or similar
